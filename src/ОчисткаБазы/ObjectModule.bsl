...
//
Функция ПрочитатьJSONОбъект(Значение, Стандарт = Истина, ПредставленияСсылок = Ложь) Экспорт 
...
//
Функция ЗаписатьJSONОбъект(Значение, Стандарт = Истина, ПредставленияСсылок = Ложь) Экспорт 
